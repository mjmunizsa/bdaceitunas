package com.example.bdaceitunas.security;
...
public class JWTAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
	...
	public Authentication attemptAuthentication(HttpServletRequest request, HttpServletResponse response)
		...
		try {
			com.example.bdaceitunas.entity.User credenciales = new ObjectMapper().readValue(request.getInputStream(),
				com.example.bdaceitunas.entity.User.class);
